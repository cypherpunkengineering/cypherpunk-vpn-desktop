      ...
      return(
        ...
        <div className="scrollable content">
          ...
          <div className="pane" data-title="Account Settings">
            <div className="setting"><a tabIndex="0" onClick={() => { shell.openExternal('https://cypherpunk.com/user/upgrade?user=' + encodeURIComponent(daemon.account.email) + '&secret=' + encodeURIComponent(daemon.account.secret)); }}>{this.isPremium() ? "Change Plan" : "Upgrade"}</a></div>
