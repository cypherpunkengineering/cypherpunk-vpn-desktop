...
const GPS = {
  ...
  'melbourne': { lat: 37.8136, long: 144.9631, scale: 1.5 },
  ...
  'sydney': { lat: 33.8688, long: 151.2093, scale: 1.5 },
      ...
      <RouteTransition transition={transitionMap}>
        ...
        <div id="connect-screen" key="self" class="screen">
          <div>
            ...
            <WorldMap locations={GPS} location={this.state.location} className="side"/>
