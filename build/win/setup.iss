...
#define MyAppVersion "0.9.9-proto"
#define MyAppNumericVersion "0.9.9"
#define MyInstallerSuffix "-0.9.9-proto"
...
[Files]
; Main binaries (run first so StopClient and StopService is executed before anything else)
...
; Remove accidental key from earlier version
Root: HKLM; Subkey: "SOFTWARE\Microsoft\Windows\CurrentVersion\Run"; ValueType: none; ValueName: "{#MyAppID}"; Flags: deletevalue;
